...
void ssd1306_border(ssd1306_t *ssd, bool value) {
  // Desenha as linhas horizontais (superior e inferior)
  ssd1306_hline(ssd, 0, ssd->width - 1, 0, value);              // Linha superior
  ssd1306_hline(ssd, 0, ssd->width - 1, ssd->height - 1, value); // Linha inferior

  // Desenha as linhas verticais (esquerda e direita)
  ssd1306_vline(ssd, 0, 0, ssd->height - 1, value);             // Linha esquerda
  ssd1306_vline(ssd, ssd->width - 1, 0, ssd->height - 1, value); // Linha direita
}
